...
export const user = { name: 'Aashik'};
export const dashboardStats ={
  totalUsers:10650,
  usersJoined: {currentMonth: 215, lastMonth:168},
  totalTrips:3150,
  tripsCreated:{currentMonth:140, lastMonth:230},
  userRole:{ total:65, currentMonth:30, lastMonth:18},
