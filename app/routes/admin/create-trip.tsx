...
export const loader = async () => {
    const response = await fetch('https://restcountries.com/v3.1/all?fields=name,latlng,maps,flags');
...
const CreateTrip = ({loaderData}: Route.ComponentProps) => {
    ...
    return (
        <main className="flex flex-col gap-10 pb-20 wrapper">
            <Header title="Add a New Trip" description="View and edit
            AI-generated travel palns"  />
